...
$result = mysqli_query($con, $query);
 if(mysqli_num_rows($result) > 0) 
 	{ 
 	 ...
 	 <div class="col-md-4"> 
 	 	<form method="post" action="index1.php?add_cart=$pro_id=<?php echo $row["product_id"]; ?>">
 	 	   ...
 	 	   <h4 class="text-danger">$ <?php echo $row["product_price"]; ?></h4>
 	 	    ...
 	 	    <input type="hidden" name="hidden_name" value="<?php echo $row["product_name"]; ?>" />
 	 	     <input type="hidden" name="hidden_price" value="<?php echo $row["product_price"]; ?>" />
 	 	      <input type="submit" name="add_cart" style="margin-top:5px;" class="btn btn-success" value="Add to Cart" /> </div>
