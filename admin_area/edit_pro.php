...
<table align="center" width="800" height="600"  border="2" bgcolor="#187eae">
...
<tr>
	...
	<td><textarea name="product_desc" cols="20" rows="10" ></textarea><?php echo $pro_desc;?>"</td>
</tr>
