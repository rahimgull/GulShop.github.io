...
<div id="mainBody">
	...
	<div class="row">
     ...
     <div id="sidebar1">
     	...
     	<div id="sidebar-tittle">My Account</div>
       ...
       <li><a href="cutomer/my_account.php?delete_account">Delete Account</a></li>
     ...
     <div id="content_area">
                ...
                if(!isset($_SESSION['customer_email'])){
                    ...
                    echo "<button style='Background:green; margin-left:120px;'><a href='checkout.php' style='color:yellow;'>Login</a></button>";

                }

                else{

                    echo "<button style='Background:green;margin-left:120px;'<a href='logout.php' style='color:yellow;' >Logout</a></button>";
                }
            ...
            if (!isset($_GET['change_pass'])){
              if (!isset($_GET['delete_account'])){
                ...
                echo " 
                  ...
                  <h2 style='padding: 2px;'>Welcome : $c_name</h2>
